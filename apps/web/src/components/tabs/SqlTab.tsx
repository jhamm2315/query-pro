...
function exportMarkdown(sql: string, prompt: string, dialect: string) {
  const lines = [
    `# SQL Query`,
    ``,
  ...
  return (
    <div className="space-y-3">
      ...
      <div className="flex items-center justify-between gap-2">
        ...
        {/* Export button */}
        <button
          onClick={() => exportMarkdown(activeSQL, prompt, dialect)}
          className="flex items-center gap-1.5 text-xs px-2.5 py-1 rounded-lg border border-gray-700 text-gray-400 hover:text-gray-200 hover:border-gray-500 transition-colors"
